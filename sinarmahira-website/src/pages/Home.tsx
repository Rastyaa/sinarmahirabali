...
const Home = () => {
  return (
    <div className="flex flex-col w-full bg-white font-jakarta">
      
      {/* Premium Hero Section */}
      <section className="relative w-full min-h-[90vh] flex items-center pt-[80px]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-brand-blue to-transparent opacity-80"></div>
        </div>

        <div className="relative z-10 max-w-[1200px] mx-auto px-[16px] md:px-[32px] w-full">
          <div className="max-w-[700px]">
            <div className="inline-flex items-center gap-[8px] bg-white/10 border border-white/20 backdrop-blur-md px-[16px] py-[6px] rounded-[8px] mb-[24px]">
              <div className="w-[8px] h-[8px] rounded-full bg-brand-coral"></div>
              <span className="text-white text-[14px] font-bold tracking-wide uppercase font-poppins">Solusi Sanitasi Terpercaya</span>
            </div>
            
            <h1 className="text-[40px] md:text-[53px] leading-[1.1] md:leading-[1.2] font-poppins font-bold mb-[24px] text-white">
              Sistem Sanitasi & <br />
              Pengolahan Air Limbah <br />
              <span className="text-brand-teal">Terbaik di Kelasnya.</span>
            </h1>
            
            <p className="text-[16px] md:text-[18px] leading-[32px] font-jakarta mb-[40px] text-white/90 max-w-[600px]">
              PT. Sinar Mahira Bali menghadirkan solusi infrastruktur sanitasi berbahan fiberglass premium untuk residensial, komersial, dan industri.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-[16px]">
              ...
              <Link to="/services" className="inline-flex justify-center items-center bg-transparent text-white h-[49px] px-[32px] rounded-[16px] font-jakarta text-[16px] font-bold border-[2px] border-white/30 hover:border-white hover:bg-white/10 transition-colors">
                Lihat Layanan
              </Link>
            </div>
          </div>
      ...
      <section className="py-[80px] md:py-[120px] bg-surface-light relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] md:gap-[64px] items-center">
            ...
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute -bottom-[24px] -right-[24px] bg-white p-[24px] rounded-[16px] shadow-floating hidden md:flex items-center gap-[16px]">
                <div className="bg-surface-light w-[48px] h-[48px] rounded-[12px] flex items-center justify-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-[16px] text-[16px] leading-[32px] text-text-secondary font-jakarta mb-[32px]">
                <p>
                  <strong className="text-text-primary font-bold">PT. Sinar Mahira Bali</strong> adalah mitra terpercaya Anda di bidang pengolahan air limbah dan solusi penyimpanan air berbahan fiberglass di Bali.
                </p>
                <p>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="flex gap-[24px] items-start">
                  <div className="w-[64px] h-[64px] rounded-[16px] bg-surface-light flex items-center justify-center shrink-0 group-hover:bg-brand-coral/10 transition-colors">
                    {service.icon}
                  </div>
                  <div>
      ...
      <section className="py-[80px] md:py-[120px] bg-brand-blue text-white">
        <div className="max-w-[1200px] mx-auto px-[16px] md:px-[32px]">
           <div className="text-center max-w-[700px] mx-auto mb-[64px]">
             <h2 className="text-[36px] md:text-[48px] font-bold mb-[16px] leading-[1.2] font-poppins">
              Mendukung Berbagai Sektor
            </h2>
            <p className="text-[16px] md:text-[18px] text-white/80 font-jakarta leading-[32px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[24px]">
            {[
              ...
              <div key={i} className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-[16px] p-[40px] hover:bg-white/20 transition-colors">
                <div className="w-[64px] h-[64px] rounded-[16px] bg-brand-coral flex items-center justify-center mb-[24px] text-white">
                  {segment.icon}
                </div>
                <h3 className="text-[24px] font-bold text-white mb-[16px] leading-[1.2] font-poppins">{segment.title}</h3>
                <p className="text-[16px] text-white/80 leading-[28px] font-jakarta">{segment.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-[100px] bg-surface-light border-b border-border-subtle">
        <div className="max-w-[1200px] mx-auto px-[16px] md:px-[32px]">
          <div className="bg-white rounded-[24px] shadow-floating p-[48px] md:p-[80px] text-center max-w-[900px] mx-auto relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-[16px]">
              ...
              <Link to="/contact" className="inline-flex justify-center items-center bg-transparent text-brand-blue h-[49px] w-[240px] rounded-[16px] font-jakarta text-[16px] font-bold border-[2px] border-brand-blue hover:bg-[#F0F5FF] transition-colors">
                Minta Penawaran
              </Link>
            </div>
          </div>
